...
function CreateOffer() {
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white text-slate-100 rounded-lg border border-slate-700">
      <h2 className="text-black text-3xl font-[poppins-sb] mb-4 text-center">
      ...
      {!successData ? (
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full p-2 rounded focus:bg-gray-400 bg-white text-black border"
          />
          ...
          <input
            ...
            className="w-full p-2 rounded focus:bg-gray-400 bg-white text-black order"
          />
          ...
          <textarea
            ...
            className="w-full p-2 rounded focus:bg-black text-white bg-white text-black  border"
          />
